                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align:right;">
                                            ...
                                            @elseif($pembelian->status == 'Sukses')
                                                ...
                                                @else
                                                    <a target="_blank"
                                                       href="https://chat.whatsapp.com/Er99xG5ODZYDwSZCHavWOb"
                                                       type="button" class="btn btn-success mt-4 mb-0">Grup WA</a>
                                                @endif
                                                <a href="{{ route('tryout.index', $pembelian->paket_id) }}"
                                                   type="button" class="btn btn-primary mt-4 mb-0">Mulai Tryout</a>
                                            @else
                                                <button type="button" onClick="pay()" class="btn btn-success mt-4 mb-0">
                                                    Bayar
                                                </button>
                                            @endif
                                        </td>
