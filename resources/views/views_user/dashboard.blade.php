            ...
            <div class="row justify-content-between">
                <div class="col-lg-7 pt-5 pt-lg-0 order-2 order-lg-1 d-flex align-items-center">
                    <div data-aos="zoom-out">
                        <h1>Selamat Datang di Website Tryout <span>Bocah Kedinasan</span></h1>
                        <h2> Membantu mempersiapkan seleksi masuk sekolah kedinasan dengan maksimal, efektif, dan
                            efisien bersama mahasiswa kedinasan</h2>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div
                        ...
                        data-aos="fade-left">
                        <h3>Kenapa harus tryout di Bocah Kedinasan</h3>
                        <p>Try out Bocah Kedinasan merupakan sarana dalam menunjang para peserta untuk masuk sekolah
                            kedinasan yang terdiri atas <b>TOBAR</b> dengan 3 gelombang dan <b>TONAS</b>. Selain
                            mendapat gambaran
                            soal, Bocah Kedinasan juga menawarkan Bimbingan <b>BIUS</b> yang tentunya membantu
                            teman-teman
                            untuk mematangkan persiapan seleksi masuk Sekolah kedinasan pilihan.</p>
                        ...
                        <div class="icon-box" data-aos="zoom-in" data-aos-delay="100">
                            ...
                            <p class="description">Soal akurat karena dibuat langsung oleh mahasiswa Polstat STIS yang
                                berpengalaman mengerjakan soal asli SPMB Polstat STIS baik SKD maupun Matematika</p>
                        </div>
                        ...
                        <div class="icon-box" data-aos="zoom-in" data-aos-delay="300">
                            ...
                            <p class="description">Dengan harga terjangkau, kamu bisa mendapatkan Try Out dan bimbingan
                                yang
                    ...
                    <div class="col-lg-3 col-md-6 mt-5 mt-lg-0">
                        <div class="count-box">
                            ...
                            <span data-purecounter-start="0" data-purecounter-end="10000" data-purecounter-duration="1"
                                  class="purecounter"></span>
                            <p>Pejuang Kedinasan telah mempercayakan Try Out dan bimbingan masuk kedinasan bersama
                                Kami</p>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-6 mt-5 mt-lg-0">
                        <div class="count-box">
                            ...
                            <span data-purecounter-start="0" data-purecounter-end="15" data-purecounter-duration="1"
                                  class="purecounter"></span>
                            <p>tahun berpengalaman menyelenggarakan Try Out dan Bimbingan masuk Polstat STIS dan
                                kedinasan
                                lainnya.</p>
                        </div>
                    </div>
                                            ...
                                            @if (Carbon\Carbon::now()->between($paket->waktu_mulai, $paket->waktu_akhir))
                                                <form method="post" action="{{ route('pembelian.store') }}">
                                                    ...
                                                    @else
                                                        ...
                                                        @elseif(in_array($paketId, ['d5f57505-fb5a-4f59-a301-3722ef581844', 'f3a1cc46-c9b1-4ff6-a441-9e710ee8eb2f']))
                                                            <a href="https://chat.whatsapp.com/IavEtnpTOwZIETqkHGJlwp"
                                                               target="_blank" type="button"
                                                               style="width: 10rem; border: 2px solid; border-color: black"
                                                               class="btn-buy mb-2">Grup WA</a>
                                                        @else
                                                            <a href="https://chat.whatsapp.com/Er99xG5ODZYDwSZCHavWOb"
                                                               target="_blank" type="button"
                                                               style="width: 10rem; border: 2px solid; border-color: black"
                                                               class="btn-buy mb-2">Grup WA</a>
                                                        @endif
                    ...
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide">
                            <div class="testimonial-item">
                                ...
                                <p>
                                    ...
                                    matematikanya sangat relevan dengan tahap 2 SPMB. Sehingga jadi terbiasa ngerjain
                                    soal
                        ...
                        <div class="swiper-slide">
                            <div class="testimonial-item">
                                ...
                                <p>
                                    <i class="bx bxs-quote-alt-left quote-icon-left"></i>
                                    Ketika tujuanmu itu terlalu tinggi, jangan kurangi tujuanmu, tapi tingkatkan
                                    usahamu!
                                    itulah yang aku tanamkan ketika ingin masuk STIS ini. Latihan-latihan soal penting
                                    banget buatku, sampai aku menemukan TONAS ini buat menguji kemampuan ku! Beberapa
                                    soal
                                    latihannya menurutku masih fresh gitu dan mirip dengan SPMB ku saat itu.
                                    Alhamdulillah,
                        ...
                        <div class="swiper-slide">
                            <div class="testimonial-item">
                                ...
                                <p>
                                    <i class="bx bxs-quote-alt-left quote-icon-left"></i>
                                    Tobar tahun 2023 keren banget, soal-soalnya semua menantang tapi masi bisa dikerjain
                                    dan
                                    lumayan yang sesuai dengan soal aslinya. semoga Tobar tahun 2024 bisa lebih keren
                                    lagi.
                                    <i class="bx bxs-quote-alt-right quote-icon-right"></i>
                                </p>
                            </div>
        ...
        @if ($faqs)
            <section id="faq" class="faq section-bg">
                <div class="container">
                                ...
                                @if ($index < 4)
                                    <li data-aos="fade-up" data-aos-delay="{{ $index * 100 }}">
                                        <i class="bx bx-help-circle icon-help"></i> <a data-bs-toggle="collapse"
                                                                                       class="{{ $index > 0 ? 'collapsed' : 'collapse'}}"
                                                                                       data-bs-target="#faq-list-{{ $index }}">{{ $faq->title }}
                    ...
                    @if ($faq->count() > 4)
                        <a data-aos="fade-up" data-aos-delay="{{ 5 * 100 }}" class="float-end mt-2"
                        ...
                        <div class="info">
                            <div class="address">
                                ...
                                <p><a style="color: inherit;"
                                      href="mailto:ukmbimbel@stis.ac.id">ukmbimbel@stis.ac.id</a>
                                </p>
                            </div>
                            ...
                            <div class="phone">
                                ...
                                <p><a style="color: inherit;" target="_blank" href="https://wa.me/6288232397969">088232397969
                                        (Anin)</a></p>
                            </div>
                            ...
                            <div class="phone">
                                ...
                                <p><a style="color: inherit;" target="_blank" href="https://wa.me/6283195559334">083195559334
                                        (Mizan)</a></p>
                            </div>
                            ...
                            <div class="phone">
                                ...
                                <p><a style="color: inherit;" target="_blank" href="https://wa.me/6281914952169">081914952169
                                        (Dinur)</a></p>
                            </div>
